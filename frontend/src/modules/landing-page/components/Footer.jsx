          ...
          <div className="lg:col-span-5 flex flex-col gap-6">
            ...
            <div className="flex items-center gap-4 py-2">
              {[
                ...
                // X (Twitter)
                <svg className="w-4 h-4 text-white hover:text-[#D2E805] transition-colors duration-300" viewBox="0 0 24 24" fill="currentColor">
                ...
                <a key={i} href="#" className="w-8 h-8 rounded-full border border-white/20 flex items-center justify-center hover:border-[#D2E805] transition-colors duration-300">
                  {icon}
                </a>
              ))}
            </div>
